# Problem Statement: 
# You have a list of daily temperatures for one month, 
...
# of the month (index 7 to index 14). Expected Outcome:
# 83, 85, 86, 87, 88, 89, 90,

specific_data = temperatures[7:14]
...
hot_point = temperatures.index(100)
data_over_100 = temperatures[hot_point + 1:]
print(data_over_100)
